local Ability_Task_PetAndMasterAddSpTag = UE4.Class(nil, "Ability_Task_PetAndMasterAddSpTag")

function Ability_Task_PetAndMasterAddSpTag:OnTaskStartBP(Context)
    ...
    _SP.SPAbilityUtils.AddStatTagsToTargets(ActionTargets, StateTagList)

end
return Ability_Task_PetAndMasterAddSpTag