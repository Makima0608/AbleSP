...
void UAblePlayParticleEffectTask::CollectDependencies(UAbleAbilityContext* Context, TArray<FString>& OutDeps)
{
	Super::CollectDependencies(Context, OutDeps);
	CollectDependenciesBP(Context, OutDeps);
}

void UAblePlayParticleEffectTask::CollectDependenciesBP_Implementation(UAbleAbilityContext* Context,
