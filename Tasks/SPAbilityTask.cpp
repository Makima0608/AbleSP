...
void USPAbilityTask::CollectDependencies(UAbleAbilityContext* Context, TArray<FString>& OutDeps)
{
	Super::CollectDependencies(Context, OutDeps);
	CollectDependenciesBP(Context, OutDeps);
}

void USPAbilityTask::CollectDependenciesBP_Implementation(UAbleAbilityContext* Context, TArray<FString>& OutDeps)
{
}
