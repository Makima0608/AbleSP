...
public:
	...
	virtual void CollectDependencies(UAbleAbilityContext* Context, TArray<FString>& OutDeps) override;
	UFUNCTION(BlueprintNativeEvent)
	void CollectDependenciesBP(UAbleAbilityContext* Context, TArray<FString>& OutDeps);
	...
	/*Get ParticleSystem */
	const UParticleSystem* GetParticleSystem() const { return m_EffectTemplate; }
